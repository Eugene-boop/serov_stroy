...
{
	$to = 'serov-stroy@mail.ru, heyalyosha@yandex.ru, info@serov-stroy.ru';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Форма:</b></td><td>' . htmlentities($_REQUEST["dop"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Удобное время для звонка:</b></td><td>' . htmlentities($_REQUEST["callDay"],ENT_COMPAT,'UTF-8') . '</td></tr>';
